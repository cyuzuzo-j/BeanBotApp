...
class Manual_SelectionFragment : Fragment() {

    private val viewModel: Manual_SelectionViewModel by viewModels {
        Manual_SelectionViewModelFactory()
    ...
    override fun onCreateView(
        ...
        viewModel.navigateTo.observe(viewLifecycleOwner) { navigateToEvent ->
            navigateToEvent.getContentIfNotHandled()?.let { navigateTo ->
                navigate(navigateTo, Screen.Manual_Survey)
            }
        }
